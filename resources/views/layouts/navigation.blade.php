<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 shadow-sm sticky top-0 z-50">
                ...
                @auth
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50 border border-gray-200">
                            @if(Auth::user()->role == 1)
                                <a href="/admin/dashboard" class="block px-4 py-2 text-sm text-purple-600 font-bold hover:bg-gray-100 border-b">Admin Panel</a>
                            @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-white border-t">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="/#about">About Us</x-responsive-nav-link>
            ...
            @auth
                ...
                <x-responsive-nav-link href="/appointments">Appointments</x-responsive-nav-link>
            @else
