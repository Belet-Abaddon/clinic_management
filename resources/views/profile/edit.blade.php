...
@section('title', 'Edit Profile - MedCLINIC')
...
<div class="py-12 bg-gray-50 min-h-screen">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div class="flex justify-between items-center">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight uppercase">Edit Patient Record</h2>
                <p class="text-sm text-gray-500">Update your contact and personal information below.</p>
            </div>
            <a href="{{ route('profile.show') }}" class="inline-flex items-center px-4 py-2 bg-white border border-gray-200 rounded-xl font-bold text-xs text-blue-600 uppercase tracking-widest hover:bg-gray-50 transition shadow-sm">
                ...
                <form method="post" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full rounded-xl border-black-600 p-3 focus:border-blue-500 focus:ring-blue-500 " required autofocus>
                        ...
                        <div>
                            ...
                            <input type="email" name="email" value="{{ old('email', $user->email) }}" class="w-full rounded-xl border-black-600 p-3 focus:border-blue-500 focus:ring-blue-500" required>
                        ...
                        <div>
                            ...
                            <input type="text" name="phone" value="{{ old('phone', $user->phone) }}" class="w-full rounded-xl border-black-600 p-3 focus:border-blue-500 focus:ring-blue-500" placeholder="+123 456 789">
                        ...
                        <div>
                            ...
                            <input type="date"
                                name="date_of_birth"
                                value="{{ old('date_of_birth', optional($user->date_of_birth)->format ? $user->date_of_birth->format('Y-m-d') : $user->date_of_birth) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" rows="3" class="w-full rounded-xl border-black-600 p-3 focus:border-blue-500 focus:ring-blue-500">{{ old('address', $user->address) }}</textarea>
