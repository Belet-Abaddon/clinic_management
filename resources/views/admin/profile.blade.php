            ...
            <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-8 py-10 text-white">
                <div class="flex flex-col md:flex-row items-center justify-between gap-6">
                    ...
                    <div class="flex gap-3">
                        <a href="{{ route('admin.profile.edit') }}" class="bg-white text-blue-600 hover:bg-gray-100 px-5 py-2.5 rounded-xl font-bold text-sm transition flex items-center shadow-md">
